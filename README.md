...
| [`2f`](examples/zstack_decoding/example_2f.ipynb)    | Set transformer encoder, allows dynamic z-stack size/placement/ordering; testing z-attention vs. information and importance |
