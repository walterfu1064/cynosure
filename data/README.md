...
bead patches that ship with the repo live in [`../examples/`](../examples/). See
[`../examples/README.md`](../examples/README.md) for their full provenance,
attribution, and crop parameters.
...
```
python examples/extract_patches.py
```
